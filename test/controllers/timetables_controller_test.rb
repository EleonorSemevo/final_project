...
class TimetablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timetable" do
    assert_difference('Timetable.count') do
      post timetables_url, params: { timetable: { day: @timetable.day, end_hour: @timetable.end_hour, hospital_speciality_id: @timetable.hospital_speciality_id, start_hour: @timetable.start_hour } }
    end
  ...
  test "should update timetable" do
    patch timetable_url(@timetable), params: { timetable: { day: @timetable.day, end_hour: @timetable.end_hour, hospital_speciality_id: @timetable.hospital_speciality_id, start_hour: @timetable.start_hour } }
