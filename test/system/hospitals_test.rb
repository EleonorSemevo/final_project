...
class HospitalsTest < ApplicationSystemTestCase
  ...
  test "creating a Hospital" do
    ...
    fill_in "Area", with: @hospital.area_id
    fill_in "Googlemap link", with: @hospital.googlemap_link
    fill_in "Name", with: @hospital.name
    fill_in "Number1", with: @hospital.number1
    fill_in "Number2", with: @hospital.number2
    check "Public" if @hospital.public
